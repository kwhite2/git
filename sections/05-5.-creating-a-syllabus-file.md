← [4. Setting Up Git](04-4.-setting-up-git.md)&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;[6. Creating Syllabus Content Using Markdown](06-6.-creating-syllabus-content-using-markdown.md) →

---

# 5. 5. Creating a Syllabus File
